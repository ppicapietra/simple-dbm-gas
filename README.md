...
| where(fieldName, criteria?, value) | Adds filters to the operation. <br> - fieldName: Name of the field to be compared. <br> - criteria: (optional) string, regular expression, or function used to evaluate the acceptance condition. <br> - value: value used for comparison in the evaluation. | SimpleDBM instance for chaining. | No |
